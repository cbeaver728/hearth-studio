...
6. **Furniture.** The Furnish tab holds around seventy pieces across Living, Kitchen & dining, Bedroom & office, Bathroom, Laundry & utility, On the walls, and Lighting: plain counter runs (straight or L-shaped) and one with just a sink, alongside the full counter with sink, cooktop and wall cabinets, islands with a sink, a cooktop, an L shape or round, ranges, dishwashers, pantry and linen cupboards, wall cabinets, double vanities, pictures and gallery walls, mirrors, wall-mounted TVs, chandeliers, pendants, ceiling fans, floor lamps and wall lights, dressers, nightstands, cribs, corner desks, bookshelves, bunk beds, laundry, a grand or upright piano with its bench, a grandfather clock, and a Christmas tree. The Outside tab adds a shed, fire pit, hot tub, planter, and bench. A preview follows your cursor, and pieces snap flush to walls. Press **E** (or ↻ on the selection bar) to turn the selected piece; arrow keys nudge it. **Ctrl+C** then **Ctrl+V** on another floor pastes it in the same spot, handy for stacking bathrooms.
...
8. **Stairs.** Straight, L-shaped, switchback, and spiral. Choose **Up** or **Down** before placing, or change it later on the right. On the plan, **UP** marks the bottom step and **DN** the top; the floor above shows the opening with a guard rail. Stairs with no floor at the other end offer to create it.
...
11. **Outside.** Patios, driveways, lawns, pools, trees, and fences live on the ground floor. Pick exterior and interior wall colors and a roof on the right, then choose **See the exterior**.
