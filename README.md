...
5. **Furniture.** The Furnish tab holds around seventy pieces across Living, Kitchen & dining, Bedroom & office, Bathroom, Laundry & utility, On the walls, and Lighting: islands with a sink, a cooktop, an L shape or round, ranges, dishwashers, pantry and linen cupboards, wall cabinets, double vanities, pictures and gallery walls, mirrors, wall-mounted TVs, chandeliers, pendants, ceiling fans, floor lamps and wall lights, dressers, nightstands, cribs, corner desks, bookshelves, bunk beds, laundry, and a Christmas tree. The Outside tab adds a shed, fire pit, hot tub, planter, and bench. A preview follows your cursor, and pieces snap flush to walls. Press **E** (or ↻ on the selection bar) to turn the selected piece; arrow keys nudge it. **Ctrl+C** then **Ctrl+V** on another floor pastes it in the same spot, handy for stacking bathrooms.
